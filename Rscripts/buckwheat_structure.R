...
mtext("K=5",side=2,line = 0.1)

# =====================================================
barplot(k6_matrix,col = c("#4682B4","red","#009933","#FF9900","#FFFF33","#9900FF"),
        #names.arg = sam_name, 
        space = 0, axes = FALSE,
        #border = NA
)
mtext("K=6",side=2,line = 0.1)

# =====================================================
barplot(k7_matrix,col = c("#4682B4","#009933","#9900FF","black","#FFFF33","red","#FF9900"),
        #names.arg = sam_name, 
        space = 0, axes = FALSE,
        #border = NA
)
mtext("K=7",side=2,line = 0.1)
